...
# python calculate_counts_from_depth_and_vaf_and_position_for_one_sample.py -i AACMY.nb2_counts.tsv -i2 AACMY.nb2_position.tsv -i3 AACMY.nb2_non_zero_events_genes_hit.bed -s AACMY -o AACMY.nb2_depth_and_vaf_and_position_tallies.tsv
...
def assign_category_of_this_event( param, i, chrom, start_chrom, end_chrom, start_pos, end_pos, start_index, end_index, depth, vaf1, vaf2, fit_f, vaf_dist_from_0p5, this_size_in_bins, fit_k1, fit_k2, fit_f_file2, this_size_in_nucleotides, num_bins_for_this_sample_FLOAT, num_bins_for_this_chromosome_FLOAT, chrom_array, start_chrom_array, end_chrom_array, chromosome_size_in_nucleotides ):
	...
	if (got_category == False):
		if ((depth >= 0.1) and (this_size_in_bins >= 3000)):
			this_event_category = "obvious_subclones"
			got_category = True
...
def main():
	...
	parser.add_argument('-p', action="store", dest="param", required=False, help='If this parameter is missing then the 2017 MGRB criteria are used. If this parameter = 2, then the 2019 ISKS criteria are used for determining overall output algorithm category.')
	...
	num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 = 0
	num_events_non_0p5_vaf = 0
	total_size_in_bins_non_0p5_vaf = 0
	total_size_in_bins_non_0p5_vaf_not_close_enough_2 = 0
	total_size_in_nucleotides_non_0p5_vaf = 0
	total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 = 0
	largest_size_in_bins_non_0p5_vaf_germline_dup = 0
	largest_size_in_nucleotides_non_0p5_vaf_germline_dup = 0
	largest_size_in_bins_non_0p5_vaf_obvious_subclones = 0
	largest_size_in_nucleotides_non_0p5_vaf_obvious_subclones = 0
	largest_size_in_bins_non_0p5_vaf_telomere_subclones = 0
	largest_size_in_nucleotides_non_0p5_vaf_telomere_subclones = 0
	largest_size_in_bins_non_0p5_vaf_focal_subclones = 0
	largest_size_in_nucleotides_non_0p5_vaf_focal_subclones = 0
	...
	avg_adjusted_model_fit_f_not_close_enough_2 = 0
	sum_fit_f = 0
	sum_adjusted_fit_f = 0
	sum_adjusted_fit_f_not_close_enough_2 = 0
	num_fit_f = 0
	num_fit_f_not_close_enough_2 = 0
	...
	largest_size_in_bins_non_zero_depth_germline_dup = 0
	largest_size_in_nucleotides_non_zero_depth_germline_dup = 0
	largest_size_in_bins_non_zero_depth_obvious_subclones = 0
	largest_size_in_nucleotides_non_zero_depth_obvious_subclones = 0
	largest_size_in_bins_non_zero_depth_telomere_subclones = 0
	largest_size_in_nucleotides_non_zero_depth_telomere_subclones = 0
	largest_size_in_bins_non_zero_depth_focal_subclones = 0
	largest_size_in_nucleotides_non_zero_depth_focal_subclones = 0
	...
	num_category_is_germline_dup_not_close_enough_2 = 0
	num_category_is_obvious_subclones = 0
	num_category_is_obvious_subclones_not_close_enough_2 = 0
	num_category_is_telomere_subclones = 0
	num_category_is_telomere_subclones_not_close_enough_2 = 0
	num_category_is_focal_subclones = 0
	num_category_is_focal_subclones_not_close_enough_2 = 0
	num_category_is_subtle_subclones_counted_as_no_subclones = 0
	num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 = 0
	...
	sum_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones = float(0)
	...
	# print "chrom", "\t", "window_id", "\t", "fit_llik", "\t", "fit_kf1", "\t", "fit_kf2", "\t", "fit_d", "\t", "fit_v1", "\t", "fit_v2", "\t", "fit_colus", "\t", "fit_col", "\t", "fit_coldisc"
	for i in range( 0, len(start_chrom_array) ):
		...
		start_index_file2 = int(start_index_array2[i])
		end_index_file2 = int(end_index_array2[i])
		start_pos = int(start_pos_array2[i])
		end_pos = int(end_pos_array2[i])
		fit_k1 = float(fit_k1_array2[i])
		fit_k2 = float(fit_k2_array2[i])
		fit_f_file2 = float(fit_f_array2[i])
		fit_isize = float(fit_isize_array2[i])
		fit_llik = float(fit_llik_array2[i])
		this_size_in_nucleotides = end_pos - start_pos + 1
		# calculate the deviation of the event from normal, in the same way it is calculated for plotting its colour in the plot program
		fit_kf1 = (fit_f_file2 * fit_k1)/2 + (1 - fit_f_file2)/2
		fit_kf2 = (fit_f_file2 * fit_k2)/2 + (1 - fit_f_file2)/2
		fit_d = math.log( (fit_kf1 + fit_kf2), 2 )
		fit_v1 = fit_kf1 / (fit_kf1 + fit_kf2)
		fit_v2 = fit_kf2 / (fit_kf1 + fit_kf2)
		fit_colus = int(fit_llik / (end_index_file2 - start_index_file2 + 1))
		fit_col = max(0, min(1, (fit_colus - (-10)) / 5))
		fit_coldisc = int(math.ceil(fit_col * 100))
		# print chrom, "\t", window_id, "\t", fit_llik, "\t", fit_kf1, "\t", fit_kf2, "\t", fit_d, "\t", fit_v1, "\t", fit_v2, "\t", fit_colus, "\t", fit_col, "\t", fit_coldisc
		...
		this_event_category, this_event_CN_category, this_event_subcategory, this_telomere_position, this_telomere_position_p, this_telomere_position_q, this_chromosome_event_for_chrom, this_chromosome_event_for_event = assign_category_of_this_event( param, i, chrom, start_chrom, end_chrom, start_pos, end_pos, start_index, end_index, depth, vaf1, vaf2, fit_f, vaf_dist_from_0p5, this_size_in_bins, fit_k1, fit_k2, fit_f_file2, this_size_in_nucleotides, num_bins_for_this_sample_FLOAT, num_bins_for_this_chromosome_FLOAT, chrom_array2, start_chrom_array, end_chrom_array, chromosome_size_in_nucleotides )

		debug = False
		if (debug):
			print( chrom, vaf1, vaf2, depth, this_size_in_bins, this_event_category, abs(vaf1 - 0.5), abs(depth) )
		is_close_enough_1_to_expected = False
		is_close_enough_2_to_expected = False
		if (param == '2'):
			close_enough_1_vaf = 0.015 # 0.005
			close_enough_1_depth = 0.05
			if (abs(vaf1 - 0.5) <= close_enough_1_vaf) and (abs(vaf2 - 0.5) <= close_enough_1_vaf) and (abs(depth) <= close_enough_1_depth): # so that we can treat very small vaf copy number as if it is not a copy number change
				is_close_enough_1_to_expected = True
			close_enough_2_vaf = 0.025 # 0.02 # 0.022
			close_enough_2_depth = 0.09 # 0.06
			if (abs(vaf1 - 0.5) <= close_enough_2_vaf) and (abs(vaf2 - 0.5) <= close_enough_2_vaf) and (abs(depth) <= close_enough_2_depth): # so that we can count up copy number changes that are not small, to identify failed_modelling
				is_close_enough_2_to_expected = True

		event_category[i] = this_event_category
		event_CN_category[i] = this_event_CN_category
		event_subcategory[i] = this_event_subcategory
		if ((this_telomere_position != '') and (this_event_CN_category == "CN_loss") and (is_close_enough_1_to_expected == False)):
			telomere_loss[this_telomere_position] = 1
		if ((this_telomere_position_p != '') and (this_event_CN_category == "CN_loss") and (is_close_enough_1_to_expected == False)):
			telomere_loss[this_telomere_position_p] = 1
		if ((this_telomere_position_q != '') and (this_event_CN_category == "CN_loss") and (is_close_enough_1_to_expected == False)):
			telomere_loss[this_telomere_position_q] = 1
		if ((this_chromosome_event_for_chrom != '') and (this_chromosome_event_for_event != '') and (is_close_enough_1_to_expected == False)):
			entire_chromosome_event[this_chromosome_event_for_chrom] = this_chromosome_event_for_event

		if (this_event_category == "germline_dup") and (is_close_enough_1_to_expected == False):
		...
		elif (this_event_category == "obvious_subclones") and (is_close_enough_1_to_expected == False):
		...
		elif (this_event_category == "telomere_subclones") and (is_close_enough_1_to_expected == False):
		...
		elif (this_event_category == "focal_subclones") and (is_close_enough_1_to_expected == False):
		...
		elif (this_event_category == "no_subclones"):
		...
		elif ((this_event_category in ["germline_dup","obvious_subclones","telomere_subclones","focal_subclones"]) and (is_close_enough_1_to_expected == True)):
			num_category_is_no_subclones = num_category_is_no_subclones + 1
			sum_adjusted_fit_f_category_is_no_subclones = sum_adjusted_fit_f_category_is_no_subclones + adjusted_fit_f
			num_category_is_subtle_subclones_counted_as_no_subclones = num_category_is_subtle_subclones_counted_as_no_subclones + 1
			sum_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones = sum_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones + adjusted_fit_f

		debug = False
		if (debug):
			print( 'chrom', chrom, 'this_event_category', this_event_category, 'this_size_in_nucleotides', this_size_in_nucleotides, 'vaf1', abs(vaf1-0.5), 'vaf2', abs(vaf2-0.5), 'depth', abs(depth) )

		if (this_event_category == "germline_dup") and (is_close_enough_2_to_expected == False):
			num_category_is_germline_dup_not_close_enough_2 = num_category_is_germline_dup_not_close_enough_2 + 1
		elif (this_event_category == "obvious_subclones") and (is_close_enough_2_to_expected == False):
			num_category_is_obvious_subclones_not_close_enough_2 = num_category_is_obvious_subclones_not_close_enough_2 + 1
		elif (this_event_category == "telomere_subclones") and (is_close_enough_2_to_expected == False):
			num_category_is_telomere_subclones_not_close_enough_2 = num_category_is_telomere_subclones_not_close_enough_2 + 1
		elif (this_event_category == "focal_subclones") and (is_close_enough_2_to_expected == False):
			num_category_is_focal_subclones_not_close_enough_2 = num_category_is_focal_subclones_not_close_enough_2 + 1
		if ((this_event_category in ["germline_dup","obvious_subclones","telomere_subclones","focal_subclones"]) and (is_close_enough_2_to_expected == True)):
			num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 = num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 + 1

		if ((vaf1 != 0.5) or (vaf2 != 0.5)) and (is_close_enough_1_to_expected == False):
			...
			if (this_event_category == "germline_dup"):
				largest_size_in_bins_non_0p5_vaf_germline_dup = max(this_size_in_bins, largest_size_in_bins_non_0p5_vaf_germline_dup)
				largest_size_in_nucleotides_non_0p5_vaf_germline_dup = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_0p5_vaf_germline_dup)
			elif (this_event_category == "obvious_subclones"):
				largest_size_in_bins_non_0p5_vaf_obvious_subclones = max(this_size_in_bins, largest_size_in_bins_non_0p5_vaf_obvious_subclones)
				largest_size_in_nucleotides_non_0p5_vaf_obvious_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_0p5_vaf_obvious_subclones)
			elif (this_event_category == "telomere_subclones"):
				largest_size_in_bins_non_0p5_vaf_telomere_subclones = max(this_size_in_bins, largest_size_in_bins_non_0p5_vaf_telomere_subclones)
				largest_size_in_nucleotides_non_0p5_vaf_telomere_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_0p5_vaf_telomere_subclones)
			elif (this_event_category == "focal_subclones"):
				largest_size_in_bins_non_0p5_vaf_focal_subclones = max(this_size_in_bins, largest_size_in_bins_non_0p5_vaf_focal_subclones)
				largest_size_in_nucleotides_non_0p5_vaf_focal_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_0p5_vaf_focal_subclones)
		...
		if ((vaf1 != 0.5) or (vaf2 != 0.5)) and (is_close_enough_2_to_expected == False):
			total_size_in_bins_non_0p5_vaf_not_close_enough_2 = total_size_in_bins_non_0p5_vaf_not_close_enough_2 + this_size_in_bins
			total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 = total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 + this_size_in_nucleotides

		if (depth != 0) and (is_close_enough_1_to_expected == False):
			...
			if (this_event_category == "germline_dup"):
				largest_size_in_bins_non_zero_depth_germline_dup = max(this_size_in_bins, largest_size_in_bins_non_zero_depth_germline_dup)
				largest_size_in_nucleotides_non_zero_depth_germline_dup = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_zero_depth_germline_dup)
			elif (this_event_category == "obvious_subclones"):
				largest_size_in_bins_non_zero_depth_obvious_subclones = max(this_size_in_bins, largest_size_in_bins_non_zero_depth_obvious_subclones)
				largest_size_in_nucleotides_non_zero_depth_obvious_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_zero_depth_obvious_subclones)
			elif (this_event_category == "telomere_subclones"):
				largest_size_in_bins_non_zero_depth_telomere_subclones = max(this_size_in_bins, largest_size_in_bins_non_zero_depth_telomere_subclones)
				largest_size_in_nucleotides_non_zero_depth_telomere_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_zero_depth_telomere_subclones)
			elif (this_event_category == "focal_subclones"):
				largest_size_in_bins_non_zero_depth_focal_subclones = max(this_size_in_bins, largest_size_in_bins_non_zero_depth_focal_subclones)
				largest_size_in_nucleotides_non_zero_depth_focal_subclones = max(this_size_in_nucleotides, largest_size_in_nucleotides_non_zero_depth_focal_subclones)
		...
		if ((vaf1 != 0.5) or (depth != 0)) and (is_close_enough_1_to_expected == False):
			num_events_where_non_0p5_vaf_or_non_zero_depth = num_events_where_non_0p5_vaf_or_non_zero_depth + 1
		if ((vaf1 != 0.5) or (depth != 0)) and (is_close_enough_2_to_expected == False):
			num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 = num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 + 1

		if (vaf1 != 0.5) and (is_close_enough_1_to_expected == False):
		...
		if (is_close_enough_2_to_expected == False):
			sum_adjusted_fit_f_not_close_enough_2 = sum_adjusted_fit_f_not_close_enough_2 + (adjusted_fit_f * this_bin_size)
			num_fit_f_not_close_enough_2 = num_fit_f_not_close_enough_2 + this_bin_size

		if ((vaf1 != 0.5) and (depth != 0)) and (is_close_enough_1_to_expected == False):
			num_non_normal_vaf_and_depth_both = num_non_normal_vaf_and_depth_both + 1
		elif ((vaf1 != 0.5) or (depth != 0)) and (is_close_enough_1_to_expected == False):
	...
	num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 = num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 - num_category_is_telomere_subclones_not_close_enough_2
	...
	avg_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones = 0
	if (num_category_is_subtle_subclones_counted_as_no_subclones > 0):
		avg_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones = sum_adjusted_fit_f_category_is_subtle_subclones_counted_as_no_subclones / float(num_category_is_subtle_subclones_counted_as_no_subclones)
	...
	if (num_fit_f_not_close_enough_2 > 0):
		avg_adjusted_model_fit_f_not_close_enough_2 = float(sum_adjusted_fit_f_not_close_enough_2) / float(num_fit_f_not_close_enough_2)
	...
	#
	# subtle_subclones: (there were events but their vaf were almost vaf=0.5 and input param == 2 so they were counted as not being subclones)
	#
	# no_subclones: (all events have vaf=0.5 and depth==0)

	this_sample_category = "no_subclones"

	if ((total_size_in_bins_non_0p5_vaf >= 700000) and (param == '')) or \
		((total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 >= 300000000) and (num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2 > 100)) or \
		((total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 >= 500000000) and (param == '2')) or \
		((total_size_in_nucleotides_non_0p5_vaf >= 500000000) and (total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2 >= 700000) and (param == '2')):
		this_sample_category = "failed_modelling"

	elif ((num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth > 50) and (avg_adjusted_model_fit_f < 0.03) and (param == '')):
		this_sample_category = "failed_modelling"

	elif ((num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth > 30) and (avg_adjusted_model_fit_f >= 0.03) and (param == '')):
		this_sample_category = "failed_modelling"

	elif ((num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth > 20) and (avg_adjusted_model_fit_f > 0.015) and (total_size_in_bins_non_0p5_vaf >= 50000) and (param == '')):
		this_sample_category = "failed_modelling"

	elif (num_category_is_obvious_subclones >= 1):
		this_sample_category = "obvious_subclones"
		if (param == '2'):
			if (num_category_is_subtle_subclones_counted_as_no_subclones > 30) and (num_category_is_subtle_subclones_counted_as_no_subclones > (num_category_is_obvious_subclones * 1.5)):
				this_sample_category = "subtle_subclones"
			elif (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 > (num_category_is_obvious_subclones_not_close_enough_2 * 1.5)):
				this_sample_category = "subtle_subclones"
			elif ((largest_size_in_bins_non_0p5_vaf_obvious_subclones >= (avg_size_in_bins_non_0p5_vaf * 1.5)) or (largest_size_in_bins_non_zero_depth_obvious_subclones >= (avg_size_in_bins_non_zero_depth * 1.5))):
				this_sample_category = "obvious_subclones"
		...
		if (param == '2'):
			if (num_category_is_subtle_subclones_counted_as_no_subclones > 30) and (num_category_is_subtle_subclones_counted_as_no_subclones > (num_category_is_germline_dup * 1.5)):
				this_sample_category = "subtle_subclones"
			elif (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 > (num_category_is_germline_dup_not_close_enough_2 * 1.5)):
				this_sample_category = "subtle_subclones"
			elif ((largest_size_in_bins_non_0p5_vaf_germline_dup >= (avg_size_in_bins_non_0p5_vaf * 1.5)) or (largest_size_in_bins_non_zero_depth_germline_dup >= (avg_size_in_bins_non_zero_depth * 1.5))):
				this_sample_category = "germline_dup"
		...
		if (param == '2'):
			if (num_category_is_subtle_subclones_counted_as_no_subclones > 30) and (num_category_is_subtle_subclones_counted_as_no_subclones > (num_category_is_telomere_subclones * 1.5)):
				this_sample_category = "subtle_subclones"
			elif (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2> 30) and (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 > (num_category_is_telomere_subclones_not_close_enough_2 * 1.5)):
				this_sample_category = "subtle_subclones"
			elif ((largest_size_in_bins_non_0p5_vaf_telomere_subclones >= (avg_size_in_bins_non_0p5_vaf * 1.5)) or (largest_size_in_bins_non_zero_depth_telomere_subclones >= (avg_size_in_bins_non_zero_depth * 1.5))):
				this_sample_category = "telomere_subclones"

	elif ((num_category_is_focal_subclones > 0) and (avg_adjusted_model_fit_f >= 0.03)):
		this_sample_category = "focal_subclones"
		if (param == '2'):
			if (num_category_is_subtle_subclones_counted_as_no_subclones > 30) and (num_category_is_subtle_subclones_counted_as_no_subclones > (num_category_is_focal_subclones * 1.5)):
				this_sample_category = "subtle_subclones"
			elif (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 > 30) and (num_category_is_subtle_subclones_counted_as_no_subclones_due_to_close_enough_2 > (num_category_is_focal_subclones_not_close_enough_2 * 1.5)):
				this_sample_category = "subtle_subclones"
			elif ((largest_size_in_bins_non_0p5_vaf_focal_subclones >= (avg_size_in_bins_non_0p5_vaf * 1.5)) or (largest_size_in_bins_non_zero_depth_focal_subclones >= (avg_size_in_bins_non_zero_depth * 1.5))):
				this_sample_category = "focal_subclones"

	if ( (param == '2') and (this_sample_category == "no_subclones") ):
		if (num_category_is_subtle_subclones_counted_as_no_subclones > 0):
			this_sample_category = "subtle_subclones"

	debug = False
	if (debug):
		print 'avg_adjusted_model_fit_f_not_close_enough_2', avg_adjusted_model_fit_f_not_close_enough_2
		print 'num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2', num_non_telomere_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2
		print 'total_size_in_bins_non_0p5_vaf_not_close_enough_2', total_size_in_bins_non_0p5_vaf_not_close_enough_2
		print 'total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2', total_size_in_nucleotides_non_0p5_vaf_not_close_enough_2
		print 'largest_size_in_bins_non_0p5_vaf_germline_dup', largest_size_in_bins_non_0p5_vaf_germline_dup
		print 'largest_size_in_nucleotides_non_0p5_vaf_germline_dup', largest_size_in_nucleotides_non_0p5_vaf_germline_dup
		print 'largest_size_in_bins_non_zero_depth_germline_dup', largest_size_in_bins_non_zero_depth_germline_dup
		print 'largest_size_in_nucleotides_non_zero_depth_germline_dup', largest_size_in_nucleotides_non_zero_depth_germline_dup
		print 'largest_size_in_bins_non_0p5_vaf_obvious_subclones', largest_size_in_bins_non_0p5_vaf_obvious_subclones
		print 'largest_size_in_nucleotides_non_0p5_vaf_obvious_subclones', largest_size_in_nucleotides_non_0p5_vaf_obvious_subclones
		print 'largest_size_in_bins_non_zero_depth_obvious_subclones', largest_size_in_bins_non_zero_depth_obvious_subclones
		print 'largest_size_in_nucleotides_non_zero_depth_obvious_subclones', largest_size_in_nucleotides_non_zero_depth_obvious_subclones
		print 'largest_size_in_bins_non_0p5_vaf_telomere_subclones', largest_size_in_bins_non_0p5_vaf_telomere_subclones
		print 'largest_size_in_nucleotides_non_0p5_vaf_telomere_subclones', largest_size_in_nucleotides_non_0p5_vaf_telomere_subclones
		print 'largest_size_in_bins_non_zero_depth_telomere_subclones', largest_size_in_bins_non_zero_depth_telomere_subclones
		print 'largest_size_in_nucleotides_non_zero_depth_telomere_subclones', largest_size_in_nucleotides_non_zero_depth_telomere_subclones
		print 'largest_size_in_bins_non_0p5_vaf_focal_subclones', largest_size_in_bins_non_0p5_vaf_focal_subclones
		print 'largest_size_in_nucleotides_non_0p5_vaf_focal_subclones', largest_size_in_nucleotides_non_0p5_vaf_focal_subclones
		print 'largest_size_in_bins_non_zero_depth_focal_subclones', largest_size_in_bins_non_zero_depth_focal_subclones
		print 'largest_size_in_nucleotides_non_zero_depth_focal_subclones', largest_size_in_nucleotides_non_zero_depth_focal_subclones
		print 'num_category_is_obvious_subclones', num_category_is_obvious_subclones
		print 'num_category_is_obvious_subclones_not_close_enough_2', num_category_is_obvious_subclones_not_close_enough_2
		...
		print 'num_category_is_telomere_subclones_not_close_enough_2', num_category_is_telomere_subclones_not_close_enough_2
		...
		print 'num_category_is_germline_dup_not_close_enough_2', num_category_is_germline_dup_not_close_enough_2
		...
		print 'num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2', num_events_where_non_0p5_vaf_or_non_zero_depth_not_close_enough_2
		...
		print 'num_category_is_focal_subclones_not_close_enough_2', num_category_is_focal_subclones_not_close_enough_2
		print 'total_size_in_bins_non_0p5_vaf', total_size_in_bins_non_0p5_vaf
		print 'total_size_in_nucleotides_non_0p5_vaf', total_size_in_nucleotides_non_0p5_vaf
		print 'avg_size_in_bins_non_0p5_vaf', avg_size_in_bins_non_0p5_vaf
		print 'avg_size_in_nucleotides_non_0p5_vaf', avg_size_in_nucleotides_non_0p5_vaf
		...
		print 'total_size_in_nucleotides_non_zero_depth', total_size_in_nucleotides_non_zero_depth
		print 'avg_size_in_bins_non_zero_depth', avg_size_in_bins_non_zero_depth
		print 'avg_size_in_nucleotides_non_zero_depth', avg_size_in_nucleotides_non_zero_depth
		print 'avg_non_0p5_vaf_dist_from_0p5', avg_non_0p5_vaf_dist_from_0p5
		print 'avg_non_zero_depth', avg_non_zero_depth
		print 'num_category_is_subtle_subclones_counted_as_no_subclones', num_category_is_subtle_subclones_counted_as_no_subclones
	if (debug):
		print 'this_sample_category', this_sample_category
